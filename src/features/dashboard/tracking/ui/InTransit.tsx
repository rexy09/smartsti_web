...
import { ITracking, ITrackingResponse } from "../types";
...
export default function InTransit({ data ,isLoading}: Props) {
              ...
              <Grid>
                <Grid.Col span={{ base: 12, md: 6, lg: 5 }}>
                  ...
                  <Paper p="sm" radius="10px" bg={Color.Background}>
                    ...
                    <Space h={"sm"} />
                    <Paper p="sm" radius="10px" bg={Color.White} mb={'sm'}>
                      <Group justify="space-between">
                        <Group>
                          {Icons.doc}
                          <div>
                    ...
                    {loading ? (
                      ...
                      <Timeline active={1} lineWidth={5} bulletSize={22}>
                        {trackings.map((tracking, index) => (
                          <Timeline.Item key={index} bullet={index == trackings.length -1? <IoLocationOutline />:null }>
                            <Grid>
