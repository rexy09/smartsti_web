...
export default function DriverFormModal({ fetchData, switchTab, update, driver, vehicles }: Props) {
          ...
          {update &&
            ...
            />
              ...
              <Switch
                ...
                onChange={(event) => { form.setValues({ is_active: event.currentTarget.checked }); }}
                label="Is active"
                size="md"
              />
            </>
